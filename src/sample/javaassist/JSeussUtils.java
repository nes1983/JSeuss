...
public class JSeussUtils {
	...
	private static CtClass createCtFactory(String factoryFullName) {
	 ...
	 */
	public static void generateClassImplements(Class<?> theClass,
	...
	public static boolean generateJavaFactoryClass(Class<?>[] toFactoryClasses,
		...
		try {
			CtClass ctFactory = createCtFactory(factoryFullName);
