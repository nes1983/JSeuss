...
public class MethodCall extends Expr {
    ...
    */
    ...
    public void changeBytes(ByteChanger bc) {
    	bc.change(iterator, currentPos);
    }
     ...
     * @throws BadBytecode 
     */
	public void transformToJSeuss() throws CannotCompileException, BadBytecode {
		int pos = currentPos;
		int c = iterator.byteAt(pos);
        if (c == INVOKEINTERFACE) { 
        	return;
        ...
        iterator.append(new byte[] {0, (byte) Expr.RETURN});
